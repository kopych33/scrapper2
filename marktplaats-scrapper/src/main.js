...
const CHAT_ID = process.env.CHAT_ID || '-1002459387818';
const BOT_API = process.env.BOT_API || '7559480542:AAGvoiYE1VJBCieR1sPfmy0PPrRB8hkcqBg';

const baseUrl = 'https://www.marktplaats.nl/l/fietsen-en-brommers/p/' ;
...
async function fetchListings() {
    try {
        const apiUrl = 'https://www.marktplaats.nl/lrp/api/search?attributeRanges[]=PriceCents%3Anull%3A0&attributesById[]=0&distanceMeters=25000&l1CategoryId=445&limit=100&offset=0&postcode=1362JJ&sortBy=SORT_INDEX&sortOrder=DECREASING&viewOptions=list-view';
